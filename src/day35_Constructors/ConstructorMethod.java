...
public class ConstructorMethod {
    ...
    public static void main(String[] args) {
        ...
        // ConstructorMethod obj = new ConstructorMethod("Hello"); it is gonna be compiler error because this contructor is not existing.
		                                                        // this contructor is with parameter such as string input
                                       
        
    //  ConstructorMethod obj2 = new ConstructorMethod(); // the constructor is not exist
